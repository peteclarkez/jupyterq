...
dl:{[s;url]$[s;;`/:]system 0N!"curl -s -L ",url,$[s;" -J -O";""]}
download:{
 0N!assets:.j.k[dl[0b]"https://api.github.com/repos/KxSystems/embedPy/releases/",$[not[count x]|x~"latest";"latest";"tags/",x]][`assets];
